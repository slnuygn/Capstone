...
def create_ui_component(parameter_name: str, parameter_info: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if parameter_info['type'] == 'range':
        ...
        component.update({
            ...
            'label': f'{parameter_name.replace("_", " ").title()}',
            'model': parameter_info.get('options', [parameter_info.get('value', '')]),
            'current_index': 0,
...
if __name__ == '__main__':
    ...
    if erp_file:
        ...
        for param_name, param_info in params.items():
            ...
            ui_component = create_ui_component(param_name, param_info)
